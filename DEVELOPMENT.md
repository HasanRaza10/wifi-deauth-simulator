...
```bash
git remote add encore encore://wifi-deauth-simulator-a5s2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/wifi-deauth-simulator-a5s2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/wifi-deauth-simulator-a5s2/settings/integrations/github)
